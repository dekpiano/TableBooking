...
<head>
    ...
    <style>
        ...
        .admin-menu-bar .admin-info {
            font-weight: 600;
            color: #444;
        }
        .admin-menu-bar .btn-group-custom {
            display: flex;
            flex-wrap: wrap;
            gap: 8px;
        }
        ...
        <div class="container main-container">
            <div class="admin-menu-bar">
                <div class="admin-info">
                    <i class="bi bi-person-circle"></i> สวัสดี, <?php echo htmlspecialchars($admin_name); ?>
                </div>
                <div class="btn-group-custom">
                    ...
                    <a href="admin_evaluations.php" class="btn btn-primary btn-sm text-white"><i class="bi bi-clipboard-check-fill text-white"></i> การประเมิน</a>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title" id="manageTableStatusModalLabel"><i class="bi bi-grid-3x3-gap"></i> จัดการสถานะ การเปิด/ปิด/ซ่อน โต๊ะในระบบ</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="text-muted mb-3"><i class="bi bi-info-circle"></i> ปรับแต่งการเปิด-ปิด และการซ่อนโต๊ะในระบบจอง (เขียว = ว่าง, แดง = จองแล้ว, เทา = ปิดจอง, ซ่อน = ไม่แสดงผล)</p>
                    <hr>
                    <div id="tableStatusGrid" class="p-3">
                        <!-- Grid of tables will be loaded here by JavaScript -->
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            document.getElementById('addBookingModal').addEventListener('show.bs.modal', async function () {
                ...
                selectTable.innerHTML = '<option value="">กำลังโหลดหมายเลขโต๊ะที่ว่าง...</option>';
